...
public class SketchwareUtil {
    ...
    public static boolean isConnected(Context _context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            Network network = _connectivityManager.getActiveNetwork();
            if (network == null) return false;
            NetworkCapabilities capabilities = _connectivityManager.getNetworkCapabilities(network);
            ...
            android.net.NetworkInfo info = _connectivityManager.getActiveNetworkInfo();
